...
$y_0$ is the maximum possible value of $R_{\max}$ .
  * ***N.B.*** Take $\mathop {\lim }\limits_{I \to \infty } \left\{ {{R_{\max }}} \right\} = \mathop {\lim }\limits_{I \to \infty } \left\{ {{{{W_ * }} \over W} \cdot \min \left( {1,{I \over B}} \right)} \right\}$ to see this more convincingly.
